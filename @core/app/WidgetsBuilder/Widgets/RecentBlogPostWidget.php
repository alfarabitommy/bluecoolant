...
class RecentBlogPostWidget extends WidgetBase
{
    ...
    public function frontend_render()
    {
        ...
        $blog_posts = Blog::where(['lang' => $user_selected_language, 'status' => 'publish'])->orderBy('id', 'DESC')->take($post_items)->get();
        ...
        foreach ($blog_posts as $post) {
            $output .= '<li class="single-recent-post-item">
                    ...
                    <div class="content">
                        <h4 class="title"><a href="' . route('frontend.blog.single', ['id' => $post->id , 'any' => \Str::slug($post->title)]) . '">' . $post->title . '</a></h4>
