...
if(get_user_lang()=='en'){
?>
<meta name="title" content="{{__('Search For:').' '.$search_term}} | Blue Coolant Indonesia - Best Radiator Coolant Solution">
...
?>
<meta name="title" content="{{__('Search For:').' '.$search_term}} | Blue Coolant Indonesia - Solusi Radiator Coolant Terbaik">
            ...
            <div class="row mt-3 mb-5">
                ...
                <div class="col-lg-12 mb-5">
                    ...
                    if (isset($_GET['search'])) {
                        $search = $_GET['search'];
                    ?>
                    <h5>   {{ get_user_lang()=='en'?'Result for':'Hasil dari' }} : <b class="c1"><?php echo $search; ?></b></h5>
                    <?php
                    }
                    ?>
