...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/backend/css/custom-style-2.css')}}">
...
<![endif]-->
@if(get_static_option('site_admin_panel_preloader_enabled'))
<div id="preloader">
...
<div class="page-container">
    ...
    <footer>
        <div class="footer-area">
            <p>
            @php
            $footer_copyright_text = get_static_option('site_'.get_default_language().'_footer_copyright');
